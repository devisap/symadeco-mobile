    ...
    return (
        <>
            ...
            >
                ...
                >
                    <View style={styles.popoverMenu}>
                        <TouchableOpacity onPress={() => screenNavigate('PemasukanEditScreen', props.item.NOMOR_PEMASUKAN)}>
            ...
            <View style={styles.itemDetailSection}>
                ...
                <View style={{flex: 1, alignItems: 'flex-end'}}>
                    <Paragraph text={getFullDate(new Date(props.item.TGLMASUK_PEMASUKAN))} />
                </View>
            </View>
            ...
            <View style={styles.itemDetailSection}>
                ...
                <View style={{flex: 1, alignItems: 'flex-end'}}>
                    <Paragraph text={`Rp. ${numberWithPoints(props.item.JML_PEMASUKAN)}`} />
                </View>
            </View>
            <View style={{marginTop: 15}} />
            <View style={styles.itemDetailSection}>
                ...
                <View style={{flex: 1, alignItems: 'flex-end'}}>
                    <Paragraph text={props.item.KETERANGAN_PEMASUKAN} />
                </View>
            </View>
        </Collapsible>
        </>
